...
Además, como verificación adicional, es recomendable asegurarse que la suma de los factores de expansión en la muestra dé un resultado coherente. En este caso, esta suma es igual a `r sum(weights(diseno))`, que es el tamaño de la población de interés. 
